...
public class UtilisateurController implements Initializable {
                ...
                public void updateItem(String item, boolean empty) {
                    ...
                    if (empty) {
                        ...
                        deleteIcon.setOnMouseClicked((MouseEvent event) -> {
                            ...
                            query = "DELETE FROM Reclamations WHERE id  ="+reclamation.getId();
                                connection = MyConnection.getInstance().getCnx();
                                preparedStatement = connection.prepareStatement(query);
                        ...
                        FXMLLoader loader = new FXMLLoader ();
                        loader.setLocation(getClass().getResource("AjoutReclamation.fxml"));
                        try {
                            loader.load();
                        } catch (IOException ex) {
                            Logger.getLogger(UtilisateurController.class.getName()).log(Level.SEVERE, null, ex);
                        ...
                        ajoutreclamationcontroller.setUpdate(true);
                         LocalDate localDate = LocalDate.parse(reclamation.getDate_declaration()); 
                        ajoutreclamationcontroller.setTextField(reclamation.getId(), reclamation.getType(),reclamation.getNom(), reclamation.getPrenom(), reclamation.getTitre(),localDate, reclamation.getDescription());
                        Parent parent = loader.getRoot();
                        Stage stage = new Stage();
                        stage.setScene(new Scene(parent));
                        stage.initStyle(StageStyle.UTILITY);
    ...
    private void home (ActionEvent event){
        FXMLLoader object = new FXMLLoader();
        try {
            Pane view = object.load(getClass().getResource("utilisateurList.fxml"));
           bp.setBottom(view);
        } catch (IOException ex) {
            Logger.getLogger(AdministrateurController.class.getName()).log(Level.SEVERE, null, ex);
        }
