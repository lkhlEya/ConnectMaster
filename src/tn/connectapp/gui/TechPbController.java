   ...
   @FXML
    ...
    private void refreshTable() {
        try {
            ...
            query = "SELECT * FROM Reclamations WHERE type='Technical Problem' AND status!= 'done'";
                ...
                public void updateItem(String item, boolean empty) {
                    ...
                    if (empty) {
                        ...
                        EyeIcon.setOnMouseClicked((MouseEvent event) -> {
                            ...
                            readonlycontroller.ReadTextField(reclamation.getId(), "Technical Problem",reclamation.getNom(), reclamation.getPrenom(), reclamation.getTitre(), localDate, reclamation.getDescription(), reclamation.getAnswer(), reclamation.getStatus());   
                        ...
                        editIcon.setOnMouseClicked((MouseEvent event) -> {
                            ...
                            repondrecontroller.setUpdate(true);
                            LocalDate localDate = LocalDate.parse(reclamation.getDate_declaration());
                            repondrecontroller.setTextField(reclamation.getId(), "Technical Problem",reclamation.getNom(), reclamation.getPrenom(), reclamation.getTitre(), localDate, reclamation.getDescription(), reclamation.getAnswer());   
                            Parent parent = loader.getRoot();
                            Stage stage = new Stage();
                            stage.setScene(new Scene(parent));
                            stage.initStyle(StageStyle.UTILITY);
