...
public class AddInternshipController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        // TODO  
        ObservableList<String> matrialStatusList = FXCollections.observableArrayList("Initiation", "Technical", "Graduation Project");
    ...
    private void getQuery() {
        ...
        if (update == false) {
            ...
            query = "INSERT INTO internship ( `ref`, `company`, `field`, `title`, `description`, `start_date`, `end_date`,`type`, `supervisor`, `status` ) VALUES (?,?,?,?,?,?,?,?,?,?)";
    ...
    private void insert() {
        ...
        try {
            ...
            preparedStatement.setString(6, String.valueOf(startDate.getValue()));
            preparedStatement.setString(7, String.valueOf(endDate.getValue()));
            preparedStatement.setString(8, (String) choix.getValue());
            preparedStatement.setString(9, tfSupervisor.getText());
            preparedStatement.setString(10, tfStatus.getText());
            preparedStatement.execute();

        } catch (SQLException ex) {
            Logger.getLogger(AddInternshipController.class.getName()).log(Level.SEVERE, null, ex);
        }
